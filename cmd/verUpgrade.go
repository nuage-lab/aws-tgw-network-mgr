...
var downloadURL = "https://github.com/nuage-lab/aws-tgw-network-mgr/raw/master/get.sh"

// upgradeCmd represents the version command
var upgradeCmd = &cobra.Command{
	Use:   "upgrade",
	Short: "upgrade awsnuagenetwmgr to latest available version",

	Run: func(cmd *cobra.Command, args []string) {
		f, err := ioutil.TempFile("", "awsnuagenetwmgr")
